...
- **Options** — settings, and every station-wide feature: hour clocks, time
  signals, rotation rules, the as-run log, the dead-air watchdog, listener
  requests, streaming, and the three sync windows
