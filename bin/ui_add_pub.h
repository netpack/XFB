...
public:
    ...
    void setupUi(QDialog *add_pub)
    {
        if (add_pub->objectName().isEmpty())
            add_pub->setObjectName(QString::fromUtf8("add_pub"));
        add_pub->setWindowModality(Qt::WindowModal);
        add_pub->resize(811, 704);
        add_pub->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        ...
        cbox_dayOfTheWeek->addItem(QString());
        cbox_dayOfTheWeek->addItem(QString());
        cbox_dayOfTheWeek->setObjectName(QString::fromUtf8("cbox_dayOfTheWeek"));
        cbox_dayOfTheWeek->setEnabled(true);
        cbox_dayOfTheWeek->setGeometry(QRect(60, 280, 100, 27));
        hourMinute = new QTimeEdit(schedules);
        hourMinute->setObjectName(QString::fromUtf8("hourMinute"));
        ...
        txt_selected_file->setObjectName(QString::fromUtf8("txt_selected_file"));
    ...
    {
        add_pub->setWindowTitle(QCoreApplication::translate("add_pub", "Add a Publicity", nullptr));
        label->setText(QCoreApplication::translate("add_pub", "Add new publicity", nullptr));
        pushButton->setText(QCoreApplication::translate("add_pub", "Save", nullptr));
        pushButton_2->setText(QCoreApplication::translate("add_pub", "Cancel", nullptr));
        schedules->setTitle(QCoreApplication::translate("add_pub", "Schedule Options", nullptr));
        dateTimeEdit->setDisplayFormat(QCoreApplication::translate("add_pub", "dd/MM/yyyy hh:mm", nullptr));
        pushButton_4->setText(QCoreApplication::translate("add_pub", "Add new", nullptr));
        pushButton_5->setText(QCoreApplication::translate("add_pub", "Delete selected", nullptr));
        label_5->setText(QCoreApplication::translate("add_pub", "Date and time:", nullptr));
        label_6->setText(QCoreApplication::translate("add_pub", "Day of the week and time:", nullptr));
        cbox_dayOfTheWeek->setItemText(0, QCoreApplication::translate("add_pub", "Monday", nullptr));
        cbox_dayOfTheWeek->setItemText(1, QCoreApplication::translate("add_pub", "Tuesday", nullptr));
        cbox_dayOfTheWeek->setItemText(2, QCoreApplication::translate("add_pub", "Wednesday", nullptr));
        cbox_dayOfTheWeek->setItemText(3, QCoreApplication::translate("add_pub", "Thursday", nullptr));
        cbox_dayOfTheWeek->setItemText(4, QCoreApplication::translate("add_pub", "Friday", nullptr));
        cbox_dayOfTheWeek->setItemText(5, QCoreApplication::translate("add_pub", "Saturday", nullptr));
        cbox_dayOfTheWeek->setItemText(6, QCoreApplication::translate("add_pub", "Sunday", nullptr));

        hourMinute->setDisplayFormat(QCoreApplication::translate("add_pub", "hh:mm", nullptr));
        pushButton_6->setText(QCoreApplication::translate("add_pub", "Add new", nullptr));
        label_7->setText(QCoreApplication::translate("add_pub", "Date interval and time:", nullptr));
        label_8->setText(QCoreApplication::translate("add_pub", "From:", nullptr));
        label_9->setText(QCoreApplication::translate("add_pub", "To:", nullptr));
        label_10->setText(QCoreApplication::translate("add_pub", "At:", nullptr));
        pushButton_7->setText(QCoreApplication::translate("add_pub", "Add new", nullptr));
        label_3->setText(QCoreApplication::translate("add_pub", "Name:", nullptr));
        label_4->setText(QCoreApplication::translate("add_pub", "File:", nullptr));
        txt_selected_file->setText(QCoreApplication::translate("add_pub", "No file selected yet...", nullptr));
        pushButton_3->setText(QCoreApplication::translate("add_pub", "Select File", nullptr));
    } // retranslateUi
