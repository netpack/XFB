...
public:
    ...
    void setupUi(QWidget *youtubedownloader)
    {
        if (youtubedownloader->objectName().isEmpty())
            youtubedownloader->setObjectName(QString::fromUtf8("youtubedownloader"));
        ...
        youtubedownloader->setStyleSheet(QString::fromUtf8("background-color:#FFF;"));
...
"background-color: rgb(83, 28, 28);"));
    ...
    {
        youtubedownloader->setWindowTitle(QCoreApplication::translate("youtubedownloader", "Youtube Downloader", nullptr));
        label->setText(QCoreApplication::translate("youtubedownloader", "Youtube Downloader", nullptr));
        label_8->setText(QCoreApplication::translate("youtubedownloader", "Moving mountains for you... please wait while our little hamsters are doing the work ;-)", nullptr));
        label_9->setText(QCoreApplication::translate("youtubedownloader", "Dowloading and Converting Video...", nullptr));
        label_10->setText(QCoreApplication::translate("youtubedownloader", "Even with a lot of electrons one must persist on thinking positive!", nullptr));
        label_5->setText(QCoreApplication::translate("youtubedownloader", "Genre 1:", nullptr));
        txt_artist->setPlaceholderText(QString());
#if QT_CONFIG(tooltip)
        checkBox_cplp->setToolTip(QCoreApplication::translate("youtubedownloader", "Check this to indicate that this is a Portuguese speaking track", nullptr));
#endif // QT_CONFIG(tooltip)
        checkBox_cplp->setText(QCoreApplication::translate("youtubedownloader", "CPLP", nullptr));
        label_4->setText(QCoreApplication::translate("youtubedownloader", "Song:", nullptr));
        label_3->setText(QCoreApplication::translate("youtubedownloader", "Artist(s):", nullptr));
        label_6->setText(QCoreApplication::translate("youtubedownloader", "Genre 2:", nullptr));
        label_7->setText(QCoreApplication::translate("youtubedownloader", "Published date:", nullptr));
        dateEdit_publishedDate->setDisplayFormat(QCoreApplication::translate("youtubedownloader", "yyyy/MM/dd", nullptr));
        label_2->setText(QCoreApplication::translate("youtubedownloader", "Video Link:", nullptr));
        txt_videoLink->setPlaceholderText(QCoreApplication::translate("youtubedownloader", "https://www.youtube.com/watch?v=qWG2dsXV5HI", nullptr));
        pushButton->setText(QCoreApplication::translate("youtubedownloader", "Manage Genres", nullptr));
        label_11->setText(QString());
        bt_youtube_getIt->setText(QCoreApplication::translate("youtubedownloader", "Get it!", nullptr));
        bt_clear->setText(QCoreApplication::translate("youtubedownloader", "Clear", nullptr));
        bt_close->setText(QCoreApplication::translate("youtubedownloader", "Close", nullptr));
    } // retranslateUi
