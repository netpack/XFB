...
1. Download `XFB-3.1420-macOS.dmg` from [GitHub Releases](https://github.com/netpack/XFB/releases)
2. Open the DMG file
...
sudo apt install ./xfb_3.1420-1_amd64.deb

# Or if dependencies are missing:
sudo dpkg -i xfb_3.1420-1_amd64.deb
sudo apt install -f
```
...
1. Download the installer from [GitHub Releases](https://github.com/netpack/XFB/releases):
   - Intel/AMD 64-bit: `XFB-3.1420-Setup.exe`
   - ARM64 (Windows on ARM, e.g. Snapdragon): `XFB-3.1420-arm64-Setup.exe`
