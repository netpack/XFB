...
public:
    ...
    void setupUi(QDialog *aboutUs)
    {
        ...
        aboutUs->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QDialog *aboutUs)
    {
        ...
        label->setText(QCoreApplication::translate("aboutUs", "<html><head/><body><p>XFB is an Open-Source Software, writen in C++,<br/>by Fr\303\251d\303\251ric Bogaerts, Founder, CEO and developer at Netpack - Online Solutions!</p><p>Any financial support is welcome.</p><p>If you can pay me a coffee please send it to ( Paypal ): fred@netpack.pt</p><p>Thank you very much for your support!<br/></p><p>For more information about Netpack visit <a href=\"http://www.netpack.pt\"><span style=\" text-decoration: underline; color:#0000ff;\">www.netpack.pt</span></a></p><p><br/></p></body></html>", nullptr));
