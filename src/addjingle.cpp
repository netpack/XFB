...
{
    ui->setupUi(this);
    // No colors of our own: the window follows whatever theme ThemeManager
    // applied to the application (light, dark, midnight or studio). The
    // dialog used to paint itself from the legacy DarkMode bool, which left
    // it white under every dark theme.
}
