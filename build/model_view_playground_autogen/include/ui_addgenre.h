...
public:
    ...
    void setupUi(QDialog *addgenre)
    {
        if (addgenre->objectName().isEmpty())
            addgenre->setObjectName(QStringLiteral("addgenre"));
        addgenre->resize(412, 494);
        addgenre->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        listGenres->setObjectName(QStringLiteral("listGenres"));
        listGenres->setGeometry(QRect(30, 90, 331, 151));
        btAddNewGenre = new QPushButton(addgenre);
        btAddNewGenre->setObjectName(QStringLiteral("btAddNewGenre"));
        ...
        txtNewGenre->setObjectName(QStringLiteral("txtNewGenre"));
        ...
        btShowGenre->setObjectName(QStringLiteral("btShowGenre"));

        gridLayout->addWidget(btShowGenre, 0, 0, 1, 1);

        btDelGenre = new QPushButton(layoutWidget);
        btDelGenre->setObjectName(QStringLiteral("btDelGenre"));
    ...
    {
        addgenre->setWindowTitle(QApplication::translate("addgenre", "Manage Genres", nullptr));
        label->setText(QString());
        label_2->setText(QApplication::translate("addgenre", "Manage Genres", nullptr));
        label_3->setText(QApplication::translate("addgenre", "Genres:", nullptr));
        btAddNewGenre->setText(QApplication::translate("addgenre", "Add Genre", nullptr));
        label_4->setText(QApplication::translate("addgenre", "Add a new Genre:", nullptr));
        close->setText(QApplication::translate("addgenre", "Close", nullptr));
        btShowGenre->setText(QApplication::translate("addgenre", "Show / Refresh List", nullptr));
        btDelGenre->setText(QApplication::translate("addgenre", "Delete Selected Genre", nullptr));
    } // retranslateUi
