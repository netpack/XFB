...
public:
    ...
    {
        add_full_dir->setWindowTitle(QCoreApplication::translate("add_full_dir", "Add a full directory", nullptr));
        label->setText(QCoreApplication::translate("add_full_dir", "Add all songs in a folder", nullptr));
        label_2->setText(QCoreApplication::translate("add_full_dir", "Folder:", nullptr));
        label_3->setText(QCoreApplication::translate("add_full_dir", "Artist name:", nullptr));
        label_4->setText(QCoreApplication::translate("add_full_dir", "Genre1:", nullptr));
        label_5->setText(QCoreApplication::translate("add_full_dir", "Genre2:", nullptr));
        label_6->setText(QCoreApplication::translate("add_full_dir", "*leave empty for auto detection (artist - song.ext)", nullptr));
        label_7->setText(QCoreApplication::translate("add_full_dir", "*", nullptr));
        f_bt_browse->setText(QCoreApplication::translate("add_full_dir", "Browse", nullptr));
        f_bt_add->setText(QCoreApplication::translate("add_full_dir", "Add", nullptr));
        label_8->setText(QCoreApplication::translate("add_full_dir", "Published date:", nullptr));
        f_date->setDisplayFormat(QCoreApplication::translate("add_full_dir", "yyyy/MM/dd", nullptr));
        f_bt_manageGenres->setText(QCoreApplication::translate("add_full_dir", "Manage genres", nullptr));
        label_9->setText(QCoreApplication::translate("add_full_dir", "Country:", nullptr));
